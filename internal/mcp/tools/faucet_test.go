...
func TestFaucetTokenSymbol(t *testing.T) {
	...
	// ERC-20 token metadata is dynamic, so no address has a static symbol.
	require.Equal(t, "", faucetTokenSymbol("0x013a61E622e6ABFCaB64F52D274C3Fc0aA37f951"))
